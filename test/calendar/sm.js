    ...
    var Calendar = function (params) {
        ...
        p.initCalendarEvents = function () {
            ...
            p.container.find('.current-year-value').on('click', function() {
                ...
                p.container.find('.picker-calendar-years').get(0).outerHTML = p.yearsHTML(curYear);
        ...
        p.yearsHTML = function(date, offset) {
            ...
            yearsHTML = '<div class="picker-calendar-years">' + yearsHTML + '</div>';
            return yearsHTML;
        };
        p.pickYear = function() {
            var year = $(this).text();
        ...
        p.layout = function () {
             ...
             * Start - edit by JSoon
             */
            var yearsHTML = p.yearsHTML(layoutDate);
            pickerHTML =
                '<div class="' + (pickerClass) + '">' +
                toolbarHTML +
                '<div class="picker-modal-inner">' +
